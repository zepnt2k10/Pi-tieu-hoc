...
\begingroup
\AddToShipoutPicture*{\put(10,530){\includegraphics[scale=0.75]{../domino1/domino-td.pdf}}}
\centering
\endgroup
%\vspace*{10pt}
	...
	đặt nối tiếp vào phải có số chấm bằng số chấm ở đầu của quân mà nó nối vào như minh hoạ ở Hình 2.%; hình dưới đây là một ví dụ.
%	\begin{figure}[H]
%	\centering
%	\vspace*{-5pt}
%	\captionsetup{labelformat=empty, justification=centering}
%	\includegraphics[width=0.39\textwidth]{dom-02}
%	\vspace*{-10pt}
%	\end{figure}
	...
	%	\vspace*{-5pt}
	%	\captionsetup{labelformat=empty, justification=centering}
	%	\includegraphics[width=0.31\textwidth]{dom-08}
	%	\vspace*{-5pt}
	%\end{figure}
	
	{\bf Cách đi}   % thêm ngày 4/12
	\vskip 0.1cm
...
%	\hspace*{0pt}(E)  Có thể có rất nhiều.
	\vskip 0.1cm
