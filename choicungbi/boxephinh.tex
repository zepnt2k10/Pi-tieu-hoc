...
\begingroup
\AddToShipoutPicture*{\put(57,530){\includegraphics[scale=0.84]{../boxephinh/tieude.pdf}}} 
\centering
\endgroup
%
\vspace*{5pt}
...
%			\vspace*{-5pt}
	...
	\vskip 0.1cm
	\begin{multicols}{2}
	Bây giờ, các bé hãy cùng thử sức với các câu hỏi tiếp theo nhé, khó hơn một chút đấy.%, chúng mình cùng gửi đáp án về cho Pi trước ngày $1/10/2019$ để nhận các phần thưởng khi giải sớm và  đúng nhé.
	\vskip 0.1cm
