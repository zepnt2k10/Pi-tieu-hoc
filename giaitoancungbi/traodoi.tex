...
\begingroup
\AddToShipoutPicture*{\put(84,610){\includegraphics[scale=0.85]{../traodoi/tieude.pdf}}} % %Image background
\centering
\endgroup
\vspace*{20pt}
	...
	\begin{figure}[H]
		...
		\vspace*{-5pt}
	\end{figure}
	\textbf{\color{toancuabi}Bài toán $\pmb{4.}$} Một cửa hàng bán hoa niêm yết giá bán hoa như sau:
	\vskip 0.15cm
