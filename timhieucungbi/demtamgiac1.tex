...
\begingroup
\AddToShipoutPicture*{\put(100,600){\includegraphics[scale=0.85]{tieude.pdf}}} 
\centering
\endgroup
...
\vspace*{35pt}
	...
	\begin{table}[H]
		...
		\resizebox{1\textwidth}{!}{\begin{tabular}{|c|c|c|c|c|c|c|}
				\hline
				\multirow{2}{4em}{\centering{\makecell{Loại\\ tam giác}}}&\multicolumn{2}{c|}{Hình $1$}&\multicolumn{2}{c|}{Hình $2$}&\multicolumn{2}{c|}{Hình $3$}\\
				\cline{2-7}
...
\begin{tabular}{|c|c|c|c|}
	\hline
	\multirow{2}{5em}{\centering{\makecell{Đường\\ nằm ngang}}}&\multicolumn{3}{c|}{Số tam giác}\\
	\cline{2-4}
