...
{\bf\color{toancuabi} Ví dụ $\pmb{4.}$} Các hình sau có bao nhiêu tam giác?
	...
	\hfill\subfloat[\textit{\color{toancuabi}Hình} $17.$]{\includegraphics[width=0.14\textwidth]  
		{Hinh23.png}}
	\hfill
	\subfloat[\textit{\color{toancuabi}Hình} $18.$]{\includegraphics[width=0.19\textwidth]{Hinh24.png}}
	\hfill\subfloat[\textit{\color{toancuabi}Hình} $19.$]{\includegraphics[width=0.25\textwidth]{Hinh25.png}}
	\hfill
	\vspace*{-10pt}
\end{figure}
...
Tuy nhiên, khi kích thước cạnh tăng lên là $4$ như Hình $19$ hay kích thước cạnh là $5$ hoặc nhiều hơn nữa thì việc đếm số tam giác trở nên phức tạp hơn nhiều. Do đó, ta phải nhanh chóng tìm ra ``câu thần chú" cho bài toán đếm tam giác dạng này nhé. 
	...
	\hfill\subfloat[\textit{\color{toancuabi}Tam giác hướng lên -- Kích thước $1$.}]{\includegraphics[width=0.19\textwidth]  
		{HinhHL11}}
	\hfill
	\subfloat[\textit{\color{toancuabi}Tam giác hướng lên -- Kích thước $2$.}]{\includegraphics[width=0.19\textwidth]{HinhHL2.png}}
	\hfill
	\subfloat[\textit{\color{toancuabi}Tam giác hướng~xuống~-- Kích thước~$1$.}]{\includegraphics[width=0.19\textwidth]{HinhHX11.png}}
	\hfill
	\subfloat[\textit{\color{toancuabi}Tam giác hướng~xuống~-- Kích thước~$2$.}]{\includegraphics[width=0.19\textwidth]{HinhHX2.png}}
	\hfill
	\vspace*{-10pt}
\end{figure}
Với bài toán này, ta sẽ giới thiệu một kiểu đếm mới, đó là đếm theo số tam giác {\color{blue}{``hướng lên"}} và {\color{orange}{``hướng xuống"}}.
\vskip 0.1cm
